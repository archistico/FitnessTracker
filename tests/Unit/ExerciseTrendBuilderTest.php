...
final class ExerciseTrendBuilderTest extends TestCase
{
    public function testBuildKeepsLatestPointsInChronologicalOrder(): void
    {
        ...
        $trend = $builder->build([
            $this->sessionSummary('2026-06-10', 3, 75.0, 100.0, 2400.0),
            $this->sessionSummary('2026-06-03', 2, 72.5, 96.5, 2300.0),
            $this->sessionSummary('2026-05-27', 1, 70.0, 93.0, 2100.0),
        ], 2);
        ...
        self::assertSame(97, $trend['points'][0]['bestEstimatedPercent']);
    ...
    public function testBuildReportsMissingTrendWithSingleSession(): void
    {
        ...
        $trend = $builder->build([
            $this->sessionSummary('2026-06-10', 1, 70.0, 93.0, 2100.0),
        ]);
